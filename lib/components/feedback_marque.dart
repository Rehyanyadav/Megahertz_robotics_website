...
class FeedbackMarque extends StatelessWidget {
  FeedbackMarque({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // First row - Marquee Cards
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(
            children: feedbackList.map((feedback) {
              return MarqueeCard(feedback: feedback);
            }).toList(),
          ),
        ),
        const SizedBox(height: 20),
        // Second row - Marquee Cards
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(
            children: feedbackList.map((feedback) {
...
class MarqueeCard extends StatelessWidget {
  ...
  const MarqueeCard({super.key, required this.feedback});
